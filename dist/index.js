...
function generateSvg(stats, options) {
  ...
  const borderStyle = options.hideBorder ? 'stroke-opacity="0"' : `stroke="#${colors.stroke}" stroke-width="1"`;
  ...
  <g transform="translate(197, 20)">
    ...
    <!-- Fire icon (must stay after the ring: SVG paint order) -->
...
async function run() {
  try {
    ...
    const fire = getInput("fire") || void 0;
    const currStreakNum = getInput("currStreakNum") || void 0;
    const sideNums = getInput("sideNums") || void 0;
    const currStreakLabel = getInput("currStreakLabel") || void 0;
    ...
    if (outputDir && !fs3.existsSync(outputDir)) {
      fs3.mkdirSync(outputDir, { recursive: true });
    }
    fs3.writeFileSync(outputPath, svg);
